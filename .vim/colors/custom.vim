...
highlight StatusLineNC  guifg=#857b6f guibg=#aaaaaa gui=none
...
highlight NonText 		  guifg=#808080 guibg=#000000 gui=none
...
call s:hifg("Comment"        ,"#aeaeae","DarkMagenta",34) " 92
" 26 instead?
call s:hifg("Constant"       ,"#d2fa3c","DarkCyan",21) " 30
call s:hifg("rubyNumber"     ,"#fbde2d","Yellow",60) " 190
call s:hifg("String"         ,"#61ce3c","LightGreen",44,82) " 82
call s:hifg("Identifier"     ,"#d2fa3c","Yellow",72) " 220
call s:hifg("Statement"      ,"#fbde2d","Brown",68) " 202
call s:hifg("PreProc"        ,"#fbde2d","LightCyan",47) " 213
call s:hifg("railsUserMethod","#ff0000","LightCyan",27)
call s:hifg("Type"           ,"#d2fa3c","Grey",57) " 101
call s:hifg("railsUserClass" ,"#ff0000","Grey",7) " 101
call s:hifg("Special"        ,"#118800","DarkGreen",24) " 7
call s:hifg("Regexp"         ,"#61ce3c","DarkCyan",21) " 74
call s:hifg("rubyMethod"     ,"#d2fa3c","Yellow",77) " 191
